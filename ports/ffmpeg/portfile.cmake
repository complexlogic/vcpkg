...
set(DEMUXERS flac mp3 ogg mov,mp4,m4a,3gp,3g2,mj2 wv ape mpc9 wav)
set(DECODERS flac mp3float vorbis opus aac alac wavpack ape mpc mpc8 pcm_s8 pcm_s16le pcm_s32le pcm_f16le pcm_f24le pcm_f32le mjpeg)
set(MUXERS mp3 ipod ogg)
set(ENCODERS libmp3lame aac libfdk_aac libvorbis libopus)
set(FILTERS volume)
set(PROTOCOLS file)
...
endforeach ()
foreach(MUXER ${MUXERS})
  set(OPTIONS "${OPTIONS} --enable-muxer=${MUXER}")
endforeach ()
foreach(ENCODER ${ENCODERS})
  set(OPTIONS "${OPTIONS} --enable-encoder=${ENCODER}")
endforeach ()
foreach(FILTER ${FILTERS})
  set(OPTIONS "${OPTIONS} --enable-filter=${FILTER}")
endforeach ()
foreach(PROTOCOL ${PROTOCOLS})
  set(OPTIONS "${OPTIONS} --enable-protocol=${PROTOCOL}")
endforeach ()
